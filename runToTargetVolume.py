...
# kevinshen@ucsb.edu                                           #
#                                                              #
# Special purpose script to run barostat until target volume   #
# is achieved.                                                 # 
#                                                              #
# 2019.02.07: currently only implemented for cubic boxes       #
#   assumes have good xml file to continue from!               #
#   checks every block, which is composed of 1x barostatfreq   #
#                                                              #
################################################################
...
if __name__ == "__main__":
    ...
    parser.add_argument("targetVol", type=float, help="target volume, in nm^3")
    parser.add_argument("paramfile", default='params.in', type=str, help="param.in file")
    parser.add_argument("inputfile", default='chk.xml', type=str, help="input xml file")
    ...
    # === RUN === #
    main(targetVol=cmdln_args.targetVol, paramfile=cmdln_args.paramfile, overrides={'incoord':cmdln_args.inputfile}, deviceid=cmdln_args.deviceid, progressreport=cmdln_args.progressreport)
